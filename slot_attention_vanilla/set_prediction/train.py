...
FLAGS = flags.FLAGS
flags.DEFINE_string("model_dir", "set_prediction/",
                    "Where to save the checkpoints.")
flags.DEFINE_integer("seed", 0, "Random seed.")
flags.DEFINE_integer("batch_size", 12, "Batch size for the model.")
...
flags.DEFINE_integer("num_train_steps", 1500, "Number of training steps.")
